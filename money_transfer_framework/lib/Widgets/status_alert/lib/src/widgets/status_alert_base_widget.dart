...
class __TDBaseWidgetState extends State<StatusAlertBaseWidget> with SingleTickerProviderStateMixin {
        ...
        child: Material(
          ...
          child: BackdropFilter(
            filter: ImageFilter.blur(
              sigmaX: widget.blurPower,
              sigmaY: widget.blurPower,
            ),
            child: Container(
  ...
  Widget buildContent() {
    double screenWidth =
        MediaQuery.of(context).orientation == Orientation.portrait ? MediaQuery.of(context).size.width : MediaQuery.of(context).size.height;
      ...
      if (widget.configuration is IconConfiguration) {
        ...
        content.add(Padding(
          ...
          child: Icon(
            ...
            color: (config.color ?? (Theme.of(context).brightness == Brightness.light ? lightAccent : darkAccent)),
        ...
        content.add(Padding(
          ...
          child: Text(
            ...
            style: widget.titleOptions.style.copyWith(
              color: widget.titleOptions.style.color ?? (Theme.of(context).brightness == Brightness.light ? lightAccent : darkAccent),
            ),
      ...
      if (widget.subtitle != null) {
        content.add(Padding(
          ...
          child: Text(
            ...
            style: widget.subtitleOptions.style
                .copyWith(color: widget.subtitleOptions.style.color ?? (Theme.of(context).brightness == Brightness.light ? lightAccent : darkAccent)),
        ...
        child: AspectRatio(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: widget.backgroundColor ?? (Theme.of(context).brightness == Brightness.dark ? darkBackground : lightBackground),
              borderRadius: widget.borderRadius,
            ),
            child: Padding(
