...
class LandingPageStyles {
  ...
  LandingPageStyles(BuildContext context) {}
}

class LandingPageMobileStyles extends LandingPageStyles {
  LandingPageMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
