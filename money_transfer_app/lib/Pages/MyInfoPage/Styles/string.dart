class MyInfoPageString {
  static String title = "My information";
  static String title1 = "Complete your registration";
  static String saveButton = "Save & Continue";

  static String firstNameHint = "First Name";
  static String middleNameHint = "Middle Name";
