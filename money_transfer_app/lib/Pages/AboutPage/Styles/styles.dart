...
class AboutPageStyles {
  ...
  AboutPageStyles(BuildContext context) {}
}

class AboutPageMobileStyles extends AboutPageStyles {
  AboutPageMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
