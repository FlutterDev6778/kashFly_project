...
class PaymentInfoPageStyles {
  ...
  PaymentInfoPageStyles(BuildContext context) {}
}

class PaymentInfoPageMobileStyles extends PaymentInfoPageStyles {
  PaymentInfoPageMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
